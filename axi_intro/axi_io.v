`timescale 1ns/100ps
// Task 1.
// - Allocate LED register at addrss 0x4000_0000
// - Enable R/W access
// - Verify operation of designerd LED unit with respective testbench using BFM
// Task 2.
// - Allocate SW register at address 0x4000_0010
// - Store in the register state of slide switches during read cycle
// - Verify operation of designerd slide switches unit with respective testbench using BFM
// Task 3.
// - Extend LED port with additional options
// - Bit set port (0x4000_0004)
// - Bit clear port (0x4000_0008)
// - Bit toggle port (0x4000_000C)
	...
	if(S_AXI_ARESETN) begin
		...
		R0_CTRL[R_DATA]: begin
			...
			case({R0_ADDR[31:2],2'b00})
				/* Here goes our registers -> Data read section */
			default: begin
		...
		W0_CTRL[W_WR]: begin
			...
			case({W0_ADDR[31:2], 2'b00})
				// Here are placed our devices -> Data write section
				default:

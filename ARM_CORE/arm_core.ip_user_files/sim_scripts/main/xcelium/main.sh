...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/ec67/hdl" +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl" +incdir+"../../../../../../../../DEV/FPGA/Xylinx/2025.2/data/rsb/busdef" +incdir+"/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_infrastructure_v1_1_0 $xmvlog_opts +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/ec67/hdl" +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl" +incdir+"../../../../../../../../DEV/FPGA/Xylinx/2025.2/data/rsb/busdef" +incdir+"/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xilinx_vip/include" \
  ...
  xmvlog -work axi_vip_v1_1_22 $xmvlog_opts -sv +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/ec67/hdl" +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl" +incdir+"../../../../../../../../DEV/FPGA/Xylinx/2025.2/data/rsb/busdef" +incdir+"/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xilinx_vip/include" \
  "../../../../arm_core.gen/sources_1/bd/main/ipshared/b16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work processing_system7_vip_v1_0_24 $xmvlog_opts -sv +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/ec67/hdl" +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl" +incdir+"../../../../../../../../DEV/FPGA/Xylinx/2025.2/data/rsb/busdef" +incdir+"/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xilinx_vip/include" \
  "../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/ec67/hdl" +incdir+"../../../../arm_core.gen/sources_1/bd/main/ipshared/9a25/hdl" +incdir+"../../../../../../../../DEV/FPGA/Xylinx/2025.2/data/rsb/busdef" +incdir+"/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xilinx_vip/include" \

...
//Command     : generate_target arm_core.bd
//Design      : arm_core
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "arm_core,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=arm_core,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=6,numReposBlks=6,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=2,da_board_cnt=3,da_clkrst_cnt=1,da_ps7_cnt=1,synth_mode=None}" *) (* HW_HANDOFF = "arm_core.hwdef" *) 
module arm_core
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [3:0]axi_gpio_1_gpio2_io_o;
  ...
  arm_core_axi_gpio_0_0 axi_gpio_0
  ...
  arm_core_axi_gpio_1_0 axi_gpio_1
  ...
  arm_core_processing_system7_0_0 processing_system7_0
       (.DDR_Addr(DDR_addr),
        .DDR_BankAddr(DDR_ba),
        .DDR_CAS_n(DDR_cas_n),
        .DDR_CKE(DDR_cke),
  ...
  arm_core_rst_ps7_0_50M_0 rst_ps7_0_50M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  arm_core_top_0_3 top_0
       (.ascii_data_0(axi_gpio_0_gpio_io_o),
        .ascii_data_1(axi_gpio_0_gpio2_io_o),
        .blink_idx(axi_gpio_1_gpio_io_o),
        .clk(processing_system7_0_FCLK_CLK0),
        .clk_out(clk_out_0),
        .ctrl_reg(axi_gpio_1_gpio2_io_o),
        .d_out(d_out_0),
        .load(load_0));
endmodule

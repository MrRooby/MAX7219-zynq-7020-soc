...
export RDI_DATADIR="/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 8  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_22 -L processing_system7_vip_v1_0_24 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot arm_core xil_defaultlib.arm_core xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim arm_core -key {Behavioral:sim_1:Functional:arm_core} -tclbatch cmd.tcl -protoinst "protoinst_files/arm_core.protoinst" -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/media/bartek/LEXAR/DEV/FPGA/Xylinx/2025.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb arm_core.wdb xsim.dir libdpi.so)
